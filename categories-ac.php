...
try {
    ...
    //requête pour produit "Antiquités & Collection"
    $sql = "SELECT * FROM items WHERE Catégorie_item = 'Antiquités & Collection'";
...
<head>
  ...
  <title>Catégorie : Antiquités & Collection</title>
...
<h1 style="text-align:center; margin-top: 20px;">Objets - Antiquités & Collection</h1>
...
<div class="items-container">
    <?php if (count($items) > 0): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center;">Aucun objet trouvé dans la catégorie Antiquités & Collection.</p>
    <?php endif; ?>
</div>
