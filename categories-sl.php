...
try {
    ...
    //requête pour prodiut "Antiquités & Collection"
    $sql = "SELECT * FROM items WHERE Catégorie_item = 'Sports & Loisirs'";
...
<head>
  ...
  <title>Catégorie : Sports & Loisirs</title>
...
<h1 style="text-align:center; margin-top: 20px;">Objets - Sports & Loisirs</h1>
...
<div class="items-container">
    <?php if (count($items) > 0): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center;">Aucun objet trouvé dans la catégorie Sports & Loisirs.</p>
    <?php endif; ?>
</div>
