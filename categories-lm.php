...
try {
    ...
    //requête pour produit "Livres & Multimédia"
    $sql = "SELECT * FROM items WHERE Catégorie_item = 'Livres & Multimédia'";
...
<head>
  ...
  <title>Catégorie : Livres & Multimédia</title>
...
<h1 style="text-align:center; margin-top: 20px;">Objets - Livres & Multimédia</h1>
...
<div class="items-container">
    <?php if (count($items) > 0): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center;">Aucun objet trouvé dans la catégorie Livres & Multimédia.</p>
    <?php endif; ?>
</div>
