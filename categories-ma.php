...
try {
    ...
    //requête pour produit "Mode & Accessoires"
    $sql = "SELECT * FROM items WHERE Catégorie_item = 'Mode & Accessoires'";
...
<head>
  ...
  <title>Catégorie : Mode & Accessoires</title>
...
<h1 style="text-align:center; margin-top: 20px;">Objets - Mode & Accessoires</h1>
...
<div class="items-container">
    <?php if (count($items) > 0): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center;">Aucun objet trouvé dans la catégorie Mode & Accessoires.</p>
    <?php endif; ?>
</div>
