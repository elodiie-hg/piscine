...
try {
    ...
    //requête pour produit "Art & Artisanat"
    $sql = "SELECT * FROM items WHERE Catégorie_item = 'Art & Artisanat'";
...
<head>
  ...
  <title>Catégorie : Art & Artisanat</title>
...
<h1 style="text-align:center; margin-top: 20px;">Objets - Art & Artisanat</h1>
...
<div class="items-container">
    <?php if (count($items) > 0): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p style="text-align:center;">Aucun objet trouvé dans la catégorie Art & Artisanat.</p>
    <?php endif; ?>
</div>
